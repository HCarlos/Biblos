...
<div class="col-sm-{{$cols}} has-error mb-1">
    ...
    <br>
    <input type="{{$tipo}}" id="{{ $Nombre }}" name="{{ $Nombre }}" @if ($valor) checked @endif class="ace-switch input-lg ace-switch-bars-h ace-switch-check ace-switch-times text-grey-l2 bgc-orange-d2 radius-2px">
