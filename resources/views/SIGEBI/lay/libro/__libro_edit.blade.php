...
<div class="form-group row">
    <x-inputs.text-field cols="1" tipo="text" nombre="ficha_no" nombrees="ficha" valor="{{old('ficha_no',$item->ficha_no)}}"></x-inputs.text-field>
    <x-inputs.select-form cols="7" nombre="tipo_material_id" nombrees="tipo de material" :arr="$TipoMaterial" valor="{{old('tipo_material_id',$item->tipo_material_id)}}"></x-inputs.select-form>
