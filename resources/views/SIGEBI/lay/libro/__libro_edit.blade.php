...
<div class="form-group row">
    ...
    <x-inputs.select-form cols="4" nombre="tipo_material_id" nombrees="tipo de material" :arr="$TipoMaterial" valor="{{old('no_coleccion',$item->tipo_material_id)}}"></x-inputs.select-form>
    <x-inputs.select-form cols="4" nombre="editorial_id" nombrees="Editorial" :arr="$Editoriales" valor="{{old('no_coleccion',$item->editorial_id)}}"></x-inputs.select-form>
</div>
<div class="form-group row">
