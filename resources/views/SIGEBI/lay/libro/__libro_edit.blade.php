<div class="form-group row">
    ...
    <x-inputs.text-field cols="9" tipo="text" nombre="etiqueta smarth" valor="{{old('etiqueta_smarth',$item->etiqueta_smarth)}}"></x-inputs.text-field>
</div>
<div class="form-group row">
...
<div class="form-group row">
    <x-inputs.text-field cols="4" tipo="text" nombre="no_coleccion" nombrees="No Colección" valor="{{old('no_coleccion',$item->no_coleccion)}}"></x-inputs.text-field>
    <x-inputs.select-form cols="4" nombre="tipo_material_id" nombrees="tipo de material" :arr="$TipoMaterial" valor="{{old('tipo_material_id',$item->tipo_material_id)}}"></x-inputs.select-form>
    <x-inputs.select-form cols="4" nombre="editorial_id" nombrees="Editorial" :arr="$Editoriales" valor="{{old('editorial_id',$item->editorial_id)}}"></x-inputs.select-form>
</div>
<div class="form-group row">
