...
<div class="form-group row">
    ...
    <x-inputs.text-field cols="3" tipo="text" nombre="no_coleccion" nombrees="No Colección" valor="{{old('no_coleccion')}}"></x-inputs.text-field>
    <x-inputs.text-field cols="3" tipo="text" nombre="codebar" nombrees="Códido de Barras" valor="{{old('codebar')}}"></x-inputs.text-field>
