<div class="form-group row">
    <x-inputs.date-field cols="12" nombre="fecha_apartado" nombrees="Fecha de Reservación" valor="{{ old('fecha_apartado',$item->fecha_apartado) }}" sololectura="true"></x-inputs.date-field>
    <x-inputs.date-field cols="12" nombre="fecha_prestamo" nombrees="Fecha de Prestamo" valor="{{ \Carbon\Carbon::now() }}" sololectura="true"></x-inputs.date-field>
    <x-inputs.date-field cols="12" nombre="fecha_entrega" nombrees="Fecha de Vencimiento" valor="{{ \Carbon\Carbon::now()->addDay(3) }}"></x-inputs.date-field>
    <div class="col-sm-12">
